...
ALLOWED_HOSTS = ['*']  # you can replace '*' with your Render domain for security
...
# Database (SQLite for now, can be replaced with PostgreSQL for production)
DATABASES = {
    'default': {
...
# Keep your development static files folder
STATICFILES_DIRS = [STATIC_DIR]

# Whitenoise storage backend (gzip + cache busting)
